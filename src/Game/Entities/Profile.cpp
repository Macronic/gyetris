...
void Profile::resetKeybindings()
{
    ...
    settings.input.left                    = sf::Keyboard::Left;
    settings.input.right                   = sf::Keyboard::Right;
    settings.input.up                      = sf::Keyboard::Up;
    settings.input.down                    = sf::Keyboard::Down;
    settings.input.drop                    = sf::Keyboard::Space;
    settings.input.rotate_clockwise        = sf::Keyboard::X;
    settings.input.rotate_counterclockwise = sf::Keyboard::Z;
    settings.input.rotate_180              = sf::Keyboard::D;
    settings.input.pause                   = sf::Keyboard::P;
    settings.input.hold                    = sf::Keyboard::C;
    settings.input.toggle_statistics       = sf::Keyboard::Num2;
    settings.input.help                    = sf::Keyboard::H;
    settings.input.high_scores             = sf::Keyboard::Num1;
    settings.input.quit                    = sf::Keyboard::Q;
