    ...
    rotation(0)
{
    ...
    {
        case Piece::S:
            this->block = Globals::Profiles::current->settings.theme.piece_S;
            break;
        case Piece::Z:
            this->block = Globals::Profiles::current->settings.theme.piece_Z;
            break;
        case Piece::O:
            this->block = Globals::Profiles::current->settings.theme.piece_O;
            break;
        case Piece::I:
            this->block = Globals::Profiles::current->settings.theme.piece_I;
            break;
        case Piece::L:
            this->block = Globals::Profiles::current->settings.theme.piece_L;
            break;
        case Piece::J:
            this->block = Globals::Profiles::current->settings.theme.piece_J;
            break;
        case Piece::T:
            this->block = Globals::Profiles::current->settings.theme.piece_T;
            break;
