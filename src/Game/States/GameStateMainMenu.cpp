...
std::string getProfileName(Window* main)
{
    ...
    std::string string_name("gyetris");
    ...
    else if (this->menuControlsActivated)
    {
        ...
        if (this->menuControls->willQuit())
        {
            ...
            switch(this->menuControls->currentID())
            {
                ...
                case CONTROLS_KEY_LEFT:
                    key = "left";
                    break;
                case CONTROLS_KEY_RIGHT:
                    key = "right";
                    break;
                case CONTROLS_KEY_DOWN:
                    key = "down";
                    break;
                case CONTROLS_KEY_DROP:
                    key = "drop";
                    break;
                case CONTROLS_KEY_ROTATE_CLOCKWISE:
                    key = "rotate_clockwise";
                    break;
                case CONTROLS_KEY_ROTATE_COUNTERCLOCKWISE:
                    key = "rotate_counterclockwise";
                    break;
                case CONTROLS_KEY_ROTATE_180:
                    key = "rotate_180";
                    break;
                case CONTROLS_KEY_PAUSE:
                    key  = "pause";
                    break;
                case CONTROLS_KEY_HOLD:
                    key  = "hold";
                    break;
                case CONTROLS_KEY_HELP:
                    key  = "help";
                    break;
                case CONTROLS_KEY_QUIT:
                    key  = "quit";
                    break;
            ...
            if (! key.empty())
            {
                ...
                int tmp = SFML::getInput(-1);

                if ((tmp != sf::Keyboard::Enter) &&
                        (tmp != '\n') &&
                        (tmp != -1) &&
