...
void Menu::handleInput()
{
    ...
    if (InputManager::isPressed("down") || // user-defined
            InputManager::isPressed(sf::Keyboard::Down) ||
            InputManager::isPressed('\t'))
        this->goNext();

    else if (InputManager::isPressed("up") ||
             InputManager::isPressed(sf::Keyboard::Up) ||
             InputManager::isPressed(sf::Keyboard::Tab))
        this->goPrevious();

    else if (InputManager::isPressed(sf::Keyboard::Home) ||
             InputManager::isPressed(sf::Keyboard::PageUp))
        this->goFirst();

    else if (InputManager::isPressed(sf::Keyboard::End) ||
             InputManager::isPressed(sf::Keyboard::PageDown))
        this->goLast();

    else if (InputManager::isPressed(sf::Keyboard::Enter) ||
             InputManager::isPressed('\n'))
    {
